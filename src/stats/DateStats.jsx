...
const DateStats = observer(function DateStats({ store, tagStore,year, month, week }) {
  var data;
  if(year && month && week){
  ...
  return <Stats years={store.years} months={store.months} weeks={store.weeks} data={data}/>
